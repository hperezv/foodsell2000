<?php
class Admin_tipotraba extends CI_Controller {
    ...
    * @constant string
    */
    const VIEW_FOLDER = 'admin/tipotraba';
    ...
    */
    public function index()
    {
        ...
        $config['base_url'] = base_url().'admin/tipotrab';
        ...
        //load the view
        $data['main_content'] = 'admin/tipotraba/list';
    ...
    public function add()
    {
        ...
        //load the view
        $data['main_content'] = 'admin/tipotraba/add';
        $this->load->view('includes/template', $data);  
    }       
    ...
    public function update()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            if ($this->form_validation->run())
            {
                ...
                //if the insert has returned true then we show the flash message
                if($this->tipotraba_model->update_manufacture($id, $data_to_store) == TRUE){
                    $this->session->set_flashdata('flash_message', 'updated');
                }else{
                    $this->session->set_flashdata('flash_message', 'not_updated');
                }
                redirect('admin/tipotraba/update'.$id.'');
